								...
								<?php foreach ($mata_kuliah as $mk): ?>
									<tr>
										...
										<td>
											...
											<a href="#"
											   onclick="showConfirmDelete('mata-kuliah', <?php echo $mk->id_mata_kuliah; ?>)"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body p-3">
					...
					<form action="<?php echo base_url('mata-kuliah/import'); ?>" method="POST" enctype="multipart/form-data">
						<div class="form-group row">
							<label for="exampleInputEmail2" class="col-sm-3 col-form-label">Contoh Format</label>
							<div class="col-sm-9">
								<a href="<?php echo base_url('import/download-samples/mata-kuliah'); ?>"
