		...
		<div class="row">
			<div class="col-md-7 grid-margin stretch-card">
				...
				<div class="card-header header-sm d-flex justify-content-between align-items-center">
					...
					<div class="card-body">
						<form action="<?php echo base_url('kelas/create'); ?>" class="form-sample" method="POST">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group row">
										<label class="col-sm-3 col-form-label">Nama Kelas</label>
										<div class="col-sm-8">
											<input type="text" class="form-control" name="nama_kelas" value="<?php echo set_value('nama_kelas'); ?>" required autocomplete="off">
